 ...
 */
  static void testAdd() {
    ...
    CTree* t3 = new CTree('A');
     // A
    // |
    // b
    assert(t3->addChild('m'));
    assert(t3->addChild('j'));

    // can't add again
    assert(t3->addChild('p'));
    assert(t3->addChild('e'));
    assert(t3->addChild('f'));
    assert(t3->addChild('c'));
    assert(t3->addChild('g'));
    assert(t3->addChild('k'));
    assert(t3->addChild('n'));
    assert((t3->addChild('B')));
    delete t3;
  ...
  static void testEqualityOp() {
    ...
    CTree* t3 = new CTree('b');
    CTree* t4 = new CTree('a');
    assert(*t1 == *t2);
    assert(*t1 == *t1);
    assert(*t2 == *t2);
    assert(!(*t3 == *t4));
