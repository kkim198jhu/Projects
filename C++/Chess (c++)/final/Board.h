...
namespace Chess
{
  class Board {
	...
	public:
		...
		//Helper Function that finds the beginning of map
		std::map<std::pair<char, char>, Piece*>::const_iterator get_map_beg() const {return occ.begin();};

		//Helper Function that finds the ending of map
		std::map<std::pair<char, char>, Piece*>::const_iterator get_map_end() const {return occ.end();};
